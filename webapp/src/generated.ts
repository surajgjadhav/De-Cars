...
/**
 * Wraps __{@link useWriteContract}__ with `abi` set to __{@link deCarsMarketplaceAbi}__ and `functionName` set to `"onERC721Received"`
 */
export const useWriteDeCarsMarketplaceOnErc721Received =
  /*#__PURE__*/ createUseWriteContract({
    abi: deCarsMarketplaceAbi,
...
/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link deCarsMarketplaceAbi}__ and `functionName` set to `"onERC721Received"`
 */
export const useSimulateDeCarsMarketplaceOnErc721Received =
  /*#__PURE__*/ createUseSimulateContract({
    abi: deCarsMarketplaceAbi,
    functionName: 'onERC721Received',
  })
...
/**
 * Wraps __{@link useWatchContractEvent}__ with `abi` set to __{@link deCarsMarketplaceAbi}__ and `eventName` set to `"CarListed"`
 */
export const useWatchDeCarsMarketplaceCarListedEvent =
